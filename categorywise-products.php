...
<html lang="en">
    <head>
        ...
        <title>Portal de Compras | Loja por Categoria </title>
        <!-- Favicon-->
...
{ ?>
                ...
                <div class="text-center text-white">
                    ...
                    <p class="lead fw-normal text-white-50 mb-0">Categoria Produtos/Itens</p>
                </div>
            <?php } ?>
            </div>
        </header>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="product-details.php?pid=<?php echo htmlentities($row['pid']);?>">Ver Opções</a></div>
                            </div>
                        </div>
                    </div>
                <?php } }  else{ ?>
     <h4 style="color:red">Nenhum Registro Encontrado</h4>
<?php } ?>
                </div>
            </div>
