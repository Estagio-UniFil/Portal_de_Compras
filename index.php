...
<html lang="en">
	<head>
	    ...
	    <title>Página inicial do Portal de Compras</title>
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Dinheiro de volta</h4>
						</div>
					</div>	
					<h6 class="text">Garantia de reembolso de 30 dias.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Frete grátis para pedidos acima de R$. 600,00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Todos os produtos com até 20% de desconto </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div  >
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Todos Produtos</h3>
...
?>
	...
	<div class="product">		
		...
		<?php if($row['productAvailability']=='In Stock'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-info">Adicionar ao Carrinho</a></div>
				<?php } else {?>
