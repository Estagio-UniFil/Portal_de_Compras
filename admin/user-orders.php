...
<html lang="en">
    <head>
        ...
        <title>Portal de Compras| Pedidos do Usuário</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Gerenciar <?php echo  $username;?>'s Pdidos</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Gerenciar <?php echo  $username;?>'s Pedidos</li>
                        </ol>
                        <div class="card mb-4">
...
?>  
                                ...
                                <tr>
                                        ...
                                        <?php $cnt=$cnt+1; } } else { ?>
                                   <tr>
                                       <th colspan="7" style="color:red;">Nenhum Pedido Encontrado</th>
                                   </tr>
                                        <?php } ?>
