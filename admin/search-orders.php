...
<html lang="en">
    <head>
        ...
        <title>Portal de Compras | Gerenciar Pedidos Pesquisados</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"> Gerenciar Pedidos Pesquisados</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active"> Gerenciar Pedidos Pesquisados</li>
                        </ol>
                        <div class="card mb-4">
...
?>
<h4 align="center" style="color:blue !important;">Resultado da Pesquisa  <?php echo $searchinput;?></h4>
<hr />
