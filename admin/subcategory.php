...
<?php include('include/sidebar.php');?>				
    ...
    <div class="alert alert-success">
        ...
        <strong>Sucesso!</strong> <?php echo htmlentities($_SESSION['msg']); ?><?php echo htmlentities($_SESSION['msg'] = ""); ?>
    </div>
<?php } ?>
...
<?php if(isset($_GET['del'])) { ?>
    <div class="alert alert-warning">
        <button type="button" class="close" data-dismiss="alert">×</button>
        <strong>Atenção!</strong> <?php echo htmlentities($_SESSION['delmsg']); ?><?php echo htmlentities($_SESSION['delmsg'] = ""); ?>
    </div>
<?php } ?>
...
<option value="">Selcionar Categoria</option> 
...
?>									
										<tr>
											...
											<a href="subcategory.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Você tem certeza que deseja deletar?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
