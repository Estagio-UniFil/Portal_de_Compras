...
unlink($imagepath);
echo "<script>alert('Imagem do Produto Atualizada com Sucesso');</script>";
...
<html lang="en">
    <head>
        ...
        <title>Portal de Compras | Atualizar Imagem</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Atualizar Imagem</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Atualizar Imagem</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
...
<div class="row" style="margin-top:1%;">
<div class="col-2">Imagem em Destaque do Produto</div>
<div class="col-4"><input type="file" name="productimage2" id="productimage2"  class="form-control" accept="image/*" title="Aceitar apenas imagens" required>
</div>
</div>
