...
<html lang="en">
    <head>
        ...
        <title>Portal de Compras | Gerenciar Pedidos Ordenados</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Gerenciar Pedidos Ordenados</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Gerenciar Pedidos Ordenados</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Detalhes do Pedido em Trânsito
                            </div>
                            <div class="card-body">
