...
echo "<script>alert('Nome de usuário ou número de contato inválido');</script>";
...
<html lang="en">
    <head>
        ...
        <title>Portal de Compras | Recuperação de Senha </title>
...
return true;
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Portal de Compras | Recuperação de Senha</h3></div>
                                    <div class="card-body">
 ...
 <div class="form-floating mb-3">
                                                <input class="form-control" id="contactno" name="contactno" type="text" placeholder="Número de Contato." required />
                                                <label for="username">Número de Contato.</label>
                                            </div>

                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputPassword" name="inputPassword" type="password" placeholder="Nova Senha" required />
                                                <label for="inputPassword">Nova Senha</label>
                                            </div>

                                             <div class="form-floating mb-3">
                                                <input class="form-control" id="cinputPassword" name="cinputPassword" type="password" placeholder="Confirmar Senha" required />
                                                <label for="inputPassword">Confirmar Senha</label>
                                            </div>
                                        
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="password-recovery.php">Esqueceu Senha?</a>
                                                <button type="submit" name="submit" class="btn btn-primary">Enviar</button>
                                            </div>
                                        </form>
                                    </div>
                              <div class="card-footer text-center py-3">
                                        <div class="small"><a href="../index.php">Voltar para a Página Inicial</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
