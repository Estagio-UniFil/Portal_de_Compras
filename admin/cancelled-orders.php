...
<html lang="en">
    <head>
        ...
        <title>Portal de Compras |Gerenciar Pedidos Cancelados</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Gerenciar Pedidos Cancelados</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Gerenciar Pedidos Cancelados</li>
                        </ol>
                        <div class="card mb-4">
