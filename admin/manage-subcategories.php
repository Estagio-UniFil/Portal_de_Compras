...
<html lang="en">
    <head>
        ...
        <title>Portal de Compras | Gerenciar Subcategorias</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Gerenciar Subcategorias</h1>
...
?>  
                                ...
                                <tr>
                                            ...
                                            <a href="manage-subcategories.php?id=<?php echo $row['subid']?>&del=delete" onClick="return confirm('Você tem certeza que deseja deletar?')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                        </tr>
                                        <?php $cnt=$cnt+1; } ?>
