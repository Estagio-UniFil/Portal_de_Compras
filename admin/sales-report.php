...
<html lang="en">
    <head>
        ...
        <title>Portal de Compras| Relatório de Vendas Entre Datas</title>
...
<div class="card-body">
<h4 align="center" style="color:blue">Formulário de Relatório de Vendas <?php echo $fdate;?> Para <?php echo $tdate;?></h4>
<hr />
...
$gamount+=$tamount;
                                         $cnt=$cnt+1; } ?>
                                       <tr>
                                           <th colspan="2">Montante Total</th>
